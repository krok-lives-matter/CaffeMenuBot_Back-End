...
namespace CaffeMenuBot.Data.Migrations
{
    ...
    [Migration("20210523145818_PhotosFixed")]
    partial class PhotosFixed
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasPostgresEnum(null, "chat_state", new[] { "default_state", "pending_comment" })
                .HasPostgresEnum(null, "rating", new[] { "rating_unrated", "rating_bad", "rating_ok", "rating_good", "rating_great", "rating_excellent" })
            ...
            modelBuilder.Entity("CaffeMenuBot.Data.Models.Bot.BotUser", b =>
                {
                    ...
                    b.Property<ChatState>("State")
                        .HasColumnType("chat_state")
                        .HasColumnName("user_chat_state");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "590c5b5e-d5e6-4b58-8711-855422b21035",
                            Name = "admin",
            ...
            modelBuilder.Entity("CaffeMenuBot.Data.Models.Dashboard.DashboardUser", b =>
                {
                    ...
                    b.Property<string>("ProfilePhotoRelativeUrl")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("profile_photo_relative_url");
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "57b0948b-fbbd-4795-9b50-fec7b055c96a",
                            Email = "admin@caffemenubot.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@CAFFEMENUBOT.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEOUxPeFGxI10VSmrte7P8nu205iUfxMzChIeiBkAK6tLVURJcLzhPCGQj1EOO6cU8Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UserName = "admin",
                            ProfilePhotoRelativeUrl = "profile_photos\\blank.jpg"
                        });
                });
